    ...
    <div className="flex items-center gap-2">
      ...
      <div className="relative">
        <select
          ...
          className="appearance-none rounded-md border border-[rgba(6,3,43,0.08)] bg-[rgba(6,3,43,0.03)] pl-2.5 pr-6 py-1.5 text-xs font-semibold text-kora-success shadow-sm focus:outline-none focus:ring-1 focus:ring-slate-300"
