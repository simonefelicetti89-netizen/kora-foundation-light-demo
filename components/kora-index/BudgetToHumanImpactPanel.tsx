      ...
      <div className="overflow-x-auto">
        <table className="w-full">
          ...
          <tbody>
            ...
            <MetricRow label="Spesa benefit monetari" s1Value={s1 ? eur(s1.economic_relief_spend, currency) : '—'} s2Value={s2 ? eur(s2.economic_relief_spend, currency) : '—'} delta={s1 && s2 ? `${eur(s2.economic_relief_spend - s1.economic_relief_spend, currency)}` : undefined} deltaPositive={s1 && s2 ? s2.economic_relief_spend < s1.economic_relief_spend : undefined} />
            <MetricRow label="Quota benefit monetari" s1Value={s1 ? pct(s1.economic_relief_share) : '—'} s2Value={s2 ? pct(s2.economic_relief_share) : '—'} delta={s1 && s2 ? `${Math.round((s2.economic_relief_share - s1.economic_relief_share) * 100)} pp` : undefined} deltaPositive={s1 && s2 ? s2.economic_relief_share < s1.economic_relief_share : undefined} />
            <MetricRow label="Spesa attivazione profonda" s1Value={s1 ? eur(s1.deep_activation_spend, currency) : '—'} s2Value={s2 ? eur(s2.deep_activation_spend, currency) : '—'} delta={s1 && s2 ? `+${eur(s2.deep_activation_spend - s1.deep_activation_spend, currency)}` : undefined} deltaPositive />
            <MetricRow label="Quota attivazione profonda" s1Value={s1 ? pct(s1.deep_activation_share) : '—'} s2Value={s2 ? pct(s2.deep_activation_share) : '—'} delta={s1 && s2 ? `+${Math.round((s2.deep_activation_share - s1.deep_activation_share) * 100)} pp` : undefined} deltaPositive />
            <MetricRow label="Debito di attivazione" s1Value={s1 ? eur(s1.activation_debt_eur, currency) : '—'} s2Value={s2 ? eur(s2.activation_debt_eur, currency) : '—'} delta={s1 && s2 ? `${eur(s2.activation_debt_eur - s1.activation_debt_eur, currency)}` : undefined} deltaPositive={s1 && s2 ? s2.activation_debt_eur < s1.activation_debt_eur : undefined} />
            <MetricRow label="Opportunità di riallocazione" s1Value={s1 ? eur(s1.reallocation_opportunity_eur, currency) : '—'} s2Value={s2 ? eur(s2.reallocation_opportunity_eur, currency) : '—'} delta={s1 && s2 ? `${eur(s2.reallocation_opportunity_eur - s1.reallocation_opportunity_eur, currency)}` : undefined} deltaPositive={s1 && s2 ? s2.reallocation_opportunity_eur < s1.reallocation_opportunity_eur : undefined} />
            <MetricRow label="Costo per Impact Unit" s1Value={s1 ? `€${s1.cost_per_impact_unit.toFixed(1)}` : '—'} s2Value={s2 ? `€${s2.cost_per_impact_unit.toFixed(1)}` : '—'} delta={s1 && s2 ? `${(s2.cost_per_impact_unit - s1.cost_per_impact_unit).toFixed(1)}` : undefined} deltaPositive={s1 && s2 ? s2.cost_per_impact_unit < s1.cost_per_impact_unit : undefined} />
            <MetricRow label="Costo per lavoratore attivato in profondità" s1Value={s1 ? eur(s1.cost_per_deep_activated_worker, currency) : '—'} s2Value={s2 ? eur(s2.cost_per_deep_activated_worker, currency) : '—'} delta={s1 && s2 ? `+${eur(s2.cost_per_deep_activated_worker - s1.cost_per_deep_activated_worker, currency)}` : undefined} deltaPositive note="Un aumento riflette l'espansione dell'accesso a programmi più profondi e strutturati. Leggere insieme al costo per IU." />
            <MetricRow label="Equità della spesa" s1Value={s1 ? s1.equity_of_spend.toFixed(2) : '—'} s2Value={s2 ? s2.equity_of_spend.toFixed(2) : '—'} delta={s1 && s2 ? `+${(s2.equity_of_spend - s1.equity_of_spend).toFixed(2)}` : undefined} deltaPositive={s1 && s2 ? s2.equity_of_spend > s1.equity_of_spend : undefined} />
            <MetricRow label="Bilanciamento investimenti per pillar" s1Value={s1 ? s1.pillar_investment_balance.toFixed(2) : '—'} s2Value={s2 ? s2.pillar_investment_balance.toFixed(2) : '—'} delta={s1 && s2 ? `+${(s2.pillar_investment_balance - s1.pillar_investment_balance).toFixed(2)}` : undefined} deltaPositive={s1 && s2 ? s2.pillar_investment_balance > s1.pillar_investment_balance : undefined} />
          </tbody>
        </table>
      </div>
