...
// No DB changes. No auth changes. No scoring changes. No worker PIB.
...
export default function PilotLifecyclePage() {
  const tenant       = tenantService.getTenant(DEMO_COMPANY_ID);
  ...
  const dpStatus     = reportFactoryService.getDecisionPackFactoryStatus(DEMO_COMPANY_ID);
