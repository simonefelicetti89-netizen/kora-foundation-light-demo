...
const GTM_TRACKS: GTMTrack[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      { n: 7, label: 'My KORA Worker Layer',     href: '/my-kora',   roleNote: 'passa a WORKER_MY_KORA' },
    ],
  },
  {
    id: 'C',
    ...
    steps: [
      ...
      { n: 9,  label: 'My KORA Worker Layer',     href: '/my-kora',         roleNote: 'passa a WORKER_MY_KORA' },
