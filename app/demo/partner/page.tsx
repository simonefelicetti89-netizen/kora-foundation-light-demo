'use client';
// P-01: Partner Workspace Preview — anteprima dimostrativa di cosa vede un partner KORA.
...
//
// PARTNER-01: relocated from app/partner/page.tsx (2026-07-04). This is a
// 100% synthetic demo preview, guarded like every other /demo/* route
// (requireDemoGate() in app/demo/partner/layout.tsx — DEMO_VIEWER/KORA_ADMIN
// only). It is NOT the live partner workspace: a real, authenticated PARTNER
// session lands on app/partner/workspace/page.tsx (requirePartnerUser(),
// fetches the partner's real network.partner_profile). The old app/partner
// root page now just redirects real partners to /partner/workspace — see
// that file for the rationale. Do not confuse this preview with the live
// surface when reading either file in isolation.
...
export default function PartnerDemoPreview() {
  ...
  return (
    <div className="space-y-10 max-w-3xl">
      ...
      <div>
        ...
        <PageMasthead
          eyebrow="Partner KORA · Anteprima demo — non è il workspace live"
          title={<><TM>KORA Network</TM> Partner — Anteprima</>}
          subline="I partner KORA sono attori di attivazione — abilitano iniziative, servizi ed evidenze verificabili per le aziende e i loro lavoratori. Questa è un'anteprima dimostrativa con dati sintetici: i partner autenticati operano nell'Area Partner reale."
