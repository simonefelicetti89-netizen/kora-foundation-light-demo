...
const GTM_TRACKS: GTMTrack[] = [
  {
    ...
    steps: [
      ...
      { n: 2, label: 'Company Workspace',        href: '/demo/company/kora-index', isLive: true, roleNote: 'KORA_ADMIN' },
      { n: 3, label: 'Activation Debt',          href: '/demo/company/activation', isLive: true, roleNote: 'KORA_ADMIN' },
      { n: 4, label: 'Reports & Board Pack',     href: '/demo/company/reports',    isLive: true, roleNote: 'KORA_ADMIN' },
    ],
  },
  {
    id: 'B',
    ...
    steps: [
      { n: 1, label: 'Demo Guide',              href: '/demo/guide' },
      { n: 2, label: 'Company Workspace',        href: '/demo/company/kora-index', isLive: true, roleNote: 'KORA_ADMIN' },
      { n: 3, label: 'KORA Index Detail',        href: '/demo/company/kora-index', isLive: true, roleNote: 'KORA_ADMIN' },
      { n: 4, label: 'Activation Debt',          href: '/demo/company/activation', isLive: true, roleNote: 'KORA_ADMIN' },
      { n: 5, label: 'Budget-to-Human-Impact',   href: '/demo/company/financial',  isLive: true, roleNote: 'KORA_ADMIN' },
      { n: 6, label: 'Reports & Board Pack',     href: '/demo/company/reports',    isLive: true, roleNote: 'KORA_ADMIN' },
  ...
  },
  {
    ...
    steps: [
      ...
      { n: 2,  label: 'Company Workspace',        href: '/demo/company/kora-index', isLive: true, roleNote: 'KORA_ADMIN' },
      { n: 3,  label: 'KORA Index Detail',        href: '/demo/company/kora-index', isLive: true, roleNote: 'KORA_ADMIN' },
      { n: 4,  label: 'Dati & Evidenze',          href: '/demo/ai-onboarding',      isLive: true, roleNote: 'KORA_ADMIN' },
      { n: 5,  label: 'Activation Debt',          href: '/demo/company/activation', isLive: true, roleNote: 'KORA_ADMIN' },
      { n: 6,  label: 'Pillar & Iniziative',      href: '/demo/company/pillars',    isLive: true, roleNote: 'KORA_ADMIN' },
      { n: 7,  label: 'Budget-to-Human-Impact',   href: '/demo/company/financial',  isLive: true, roleNote: 'KORA_ADMIN' },
      { n: 8,  label: 'Reports & Board Pack',     href: '/demo/company/reports',    isLive: true, roleNote: 'KORA_ADMIN' },
      { n: 9,  label: 'My KORA Worker Layer',     href: '/my-kora',                 isLive: true, roleNote: 'KORA_ADMIN + WORKER' },
      { n: 10, label: 'Partner Workspace',        href: '/demo/network',            isLive: true, roleNote: 'KORA_ADMIN + PARTNER' },
